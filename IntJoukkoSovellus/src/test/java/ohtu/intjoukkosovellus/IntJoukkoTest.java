...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.lukuOnAlkoidenJoukossa(10));
        assertFalse(joukko.lukuOnAlkoidenJoukossa(5));
        assertTrue(joukko.lukuOnAlkoidenJoukossa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.lukuOnAlkoidenJoukossa(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.lukuOnAlkoidenJoukossa(11));
        joukko.poista(11);
        assertFalse(joukko.lukuOnAlkoidenJoukossa(11));
